...
\name{Alexander Myltsev} % Your name
\address{\href{mailto:alexander.myltsev@phystech.edu}{alexander.myltsev@phystech.edu}, blog: \href{http://myltsev.name}{http://myltsev.name}, CV: \href{http://myltsev.name/cv}{http://myltsev.name/cv}} % Your address
\address{skype: alexander.myltsev, github: alexander-myltsev} % Your secondary addess (optional)
...
\item October 2013, Participant of "Start in Garage" two days startup acceleration program at MIPT. Organized by RISVentures.com
...
\item June 2009, NVIDIA and Intel Summer School at MIPT
