...
\address{CV update: July, 2021 $\vert$ \href{https://myltsev.com/cv}{https://myltsev.com/cv}}
...
\item developing state of the art machine learning models in process manufacturing
      which increase efficiency and reduce costs
\item responsible to deliver robust models to the end user
\item among clients are \href{http://yandex.ru}{Yandex},
      \href{http://eng.mmk.ru/}{Magnitogorsk Iron \& Steel Works},
      \href{https://eng.superox.ru/documents/}{SuperOx}
\item working on my Ph.D. thesis in financial mathematics
\end{rSubsection}
\end{samepage}

\begin{samepage}
\begin{rSubsection}{\href{https://github.com/cifrum-io/cifrum}
{Cifrum -- Assets Portfolio Analysis Toolkit}}
{June 2018 -- August 2019}{\textbf{Full-stack Core Developer (Remote Contractor)}}
{\href{https://github.com/cifrum-io/cifrum}{https://github.com/cifrum-io/cifrum}}
\item taught myself personal finance based on \textbf{modern portfolio theory}
